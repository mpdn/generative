...
std::string coherent::examples::Fractal::description()
{
	return "Creates fractal noise";
}

void coherent::examples::Fractal::options(boost::program_options::options_description& description)
{
...
void coherent::examples::Fractal::draw(TGAImage& image)
{
...
{
	return coherent::examples::Fractal().execute(argc, argv);
}
#endif
